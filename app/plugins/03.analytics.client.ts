...
export default defineNuxtPlugin((nuxtApp) => {
    ...
    onNuxtReady(async () => {
        ...
        // Best practice: only identify a KNOWN user. Anonymous visitors keep
        // Mixpanel's auto $device_id (localStorage-persisted, stable across days);
        // our `anonymous_id` super-prop above is the controlled handle on each event.
