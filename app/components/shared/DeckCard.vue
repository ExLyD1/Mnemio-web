    ...
    >
        <SharedCoverArt :swatch="deck.swatch" :glyph="deck.glyph" class="aspect-[16/9]">
            <button
                ...
                :aria-label="deck.favorite ? 'Remove favourite' : 'Add favourite'"
            ...
            >
                <SharedPill tone="due">{{ deck.due }} due</SharedPill>
            </span>
        </SharedCoverArt>
        ...
        <div class="flex flex-col gap-2 px-2 pb-1">
            ...
            <template v-if="variant !== 'discover'">
                ...
                <p class="text-small text-brand-muted">{{ deck.masteredPct }}% mastered</p>
            </template>
            ...
            <div v-else-if="variant === 'discover'" class="mt-1 flex items-center justify-between">
                <span class="text-small text-brand-muted">{{ deck.copies ?? 0 }} copies</span>
