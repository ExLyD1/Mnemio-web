<template>
    <div
        class="rounded-xl border border-brand-muted px-4 pb-3 pt-2 transition-colors focus-within:border-brand-bright focus-within:shadow-[0_0_0_3px_rgba(124,69,118,0.18)]"
    >
