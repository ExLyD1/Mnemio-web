<template>
    <div
        class="rounded-xl border border-brand-muted bg-bg-well px-4 pb-3 pt-2 transition-colors focus-within:border-brand-bright focus-within:shadow-focus-ring"
    >
